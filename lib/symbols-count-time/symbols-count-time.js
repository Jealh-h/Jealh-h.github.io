...
function symbolsTime(post, awl = config.awl, wpm = config.wpm, suffix = config.suffix) {
...
function symbolsTimeTotal(site, awl = config.awl, wpm = config.wpm, suffix = config.suffix) {
